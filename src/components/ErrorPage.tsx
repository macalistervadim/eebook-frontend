...
export function ErrorPage({ code }: ErrorPageProps) {
    ...
    return (
        <div className="relative min-h-screen flex items-center justify-center px-6 bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-950 overflow-hidden">
            ...
            >
                ...
                <div className="mb-12">
                    <div className="relative inline-flex">
                        {/* soft glow */}
                        <div
                            className={`absolute inset-0 blur-[60px] opacity-60 bg-gradient-to-r ${content.gradient}`}
                        />
                        <motion.div
                ...
                >
                    <Button
                        typeButton="emerald"
                        className={`px-5 py-3 rounded-xl bg-gradient-to-r ${content.gradient} text-white shadow-lg shadow-black/10`}
                        onClick={() => navigate("/")}
                    >
                    ...
                    <Button
                        typeButton="noBg"
                        className="px-5 py-3 rounded-xl border border-slate-300/60 dark:border-slate-700/60 hover:bg-slate-100/40 dark:hover:bg-slate-800/40 transition flex items-center"
                    >
