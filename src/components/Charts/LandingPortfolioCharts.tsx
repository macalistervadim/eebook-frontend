...
function LandingPortfolioCharts() {
    return (
        <>
            <div className="shadow-lg col-span-2 flex flex-col border group p-8 h-full border-slate-200 transition-all duration-300 hover:shadow-emerald-100/50 hover:translate-y-1 rounded-3xl text-left hover:border-emerald-200 hover:shadow-sm hover:bg-emerald-100/20 cursor-pointer">
                ...
                <div className="h-64">
                    <ResponsiveContainer width="100%" height="100%">
                        <AreaChart data={areaData} margin={{ top: 5, right: 20, left: 0, bottom: 5 }}>
                            ...
                            <YAxis stroke="#94a3b8" />
                            <Tooltip
                                formatter={(value, name) => [`${value} ₽`, 'Стоимость']}
            ...
            <div className="shadow-lg flex flex-col border group p-8 h-full border-slate-200 transition-all duration-300 hover:shadow-emerald-100/50 hover:translate-y-1 rounded-3xl text-left hover:border-emerald-200 hover:shadow-sm hover:bg-emerald-100/20 cursor-pointer">
